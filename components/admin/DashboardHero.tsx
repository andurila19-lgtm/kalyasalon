...
export const DashboardHero: React.FC = () => {
  ...
  return (
    <div className="kalya-executive-dashboard">
        ...
        <div className="kalya-dash-brand">
          ...
          <div>
            ...
            <h1 className="kalya-dash-title">
              Kalya Salon <span className="kalya-gold-gradient">CMS Dashboard</span>
            </h1>
            <p className="kalya-dash-subtitle">
              Pusat pengelolaan katalog layanan salon, tarif perawatan, portofolio galeri foto, dan ulasan pelanggan.
            </p>
          </div>
        </div>
      ...
      {/* 4. STEP-BY-STEP CHEATSHEET FOR OWNER */}
